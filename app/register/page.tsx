...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const steps = [
      ...
      { name: "Recording on blockchain", delay: 3000 },
      { name: "Finalizing registration", delay: 1000 },
    ]
          ...
          <Card className="bg-white/5 border-white/10 backdrop-blur-sm">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-gray-300 text-lg">
                Your video has been successfully registered on VideoAuthChain
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 p-6 rounded-lg border border-white/10">
                ...
                <ul className="text-gray-300 space-y-1 text-sm">
                  <li>• Your video is now permanently registered on the blockchain</li>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">Protect your content by registering it on the blockchain</p>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            {[
              ...
              { step: 4, name: "Blockchain Record", icon: Shield },
              { step: 5, name: "Complete", icon: CheckCircle },
            ...
            {!isUploading ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 p-4 rounded-lg border border-white/10">
                  <h3 className="text-white font-semibold mb-2">Registration Process</h3>
                  <ul className="text-gray-300 space-y-1 text-sm">
                    ...
                    <li>• Registration will be recorded on the blockchain</li>
                ...
                <Button
                  ...
                  disabled={!formData.file || !formData.title || !formData.creator || !formData.description}
                >
                  Register Video on Blockchain
                </Button>
              </form>
            ) : (
              <div className="text-center py-8">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">
                  ...
                  {step === 4 && "Recording on blockchain..."}
                  {step === 5 && "Finalizing registration..."}
                </h3>
                <p className="text-gray-300">Please wait while we securely register your video</p>
              </div>
            )}
          </CardContent>
        </Card>
